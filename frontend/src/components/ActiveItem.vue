...
<template>
	<div class="p-2 border-b relative bg-white" @click="$emit('toggle-expand')">
		<div class="grid grid-cols-2">
			...
			<div class="flex flex-nowrap col-span-2" :class="{'hidden': !expanded}">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="mr-2 text-pink-400 size-4">
